...
class BugReportDTO extends TicketRequestDTO {
    ...
    @NotBlank(message = "Steps to reproduce cannot be blank")
...
class FeatureRequestDTO extends TicketRequestDTO {
    ...
    @Min(value = 1, message = "Business value points must be greater than 0")
...
class TicketController {
    ...
    public String createTicket(@Valid @RequestBody TicketRequestDTO ticket) {
...
class GlobalExceptionHandler {
    ...
    // Unsupported type like HOTFIX
    @ExceptionHandler(InvalidTypeIdException.class)
    public ResponseEntity<String> handleInvalidType(
            InvalidTypeIdException ex) {

        throw new UnsupportedTicketTypeException("Unsupported ticket type.");
    }

    // Custom Exception
    @ExceptionHandler(UnsupportedTicketTypeException.class)
    public ResponseEntity<String> handleUnsupported(
